...
class Image
{
	...
	/**
	 * @var integer Durée du header cache-max-age
	 */
	...
	public function writeInOutput()
	{
		...
		header("Cache-Control: maxage=" . $this->cacheMaxAge);
	...
	/**
	 * Modifie la durée du header cache-max-age
	 *
	 * @param integer $duree  durée en seconde
	 * @throws \Exception
	 
	 */
	public function setCacheMaxAge($duree)
	{
		if (!is_numeric($duree)) {
			throw new \Exception('valeur numérique attendue');
		}
		$this->cacheMaxAge = $duree;
	}
